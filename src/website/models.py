...
class Page(models.Model):
    ...
    background_image = models.ImageField(upload_to='page_bg_images/%Y/', max_length=255, null=True, blank=True,
...
class Testimonial(models.Model):
    ...
    writer_profile_image = models.ImageField(upload_to='writer_testemonial_images/%Y/', max_length=255, default='default.jpg',
                                validators=[FileExtensionValidator(allowed_extensions=['jpg', 'png', 'jpeg', 'gif'])])
...
class BlogPost(models.Model):
    title = models.CharField(max_length=100)
    slug = models.SlugField()
    background_image = models.ImageField(upload_to='blogpost_bg_images/%Y/', max_length=255, null=True, blank=True,
                                validators=[FileExtensionValidator(allowed_extensions=['jpg', 'png', 'jpeg', 'gif'])])
    content = models.TextField()
    author = models.ForeignKey(User, on_delete=models.CASCADE)
    date = models.DateTimeField(default=datetime.now,blank=True)
...
class Project(models.Model):
    title = models.CharField(max_length=100)
    slug = models.SlugField()
    project_image = models.ImageField(upload_to='project_images/%Y/', max_length=255, null=True, blank=True,
                                validators=[FileExtensionValidator(allowed_extensions=['jpg', 'png', 'jpeg', 'gif'])])
    content = models.TextField()
